...
interface ListArchiveCardProps {
  artifact: any;
...
export const ListArchiveCard: React.FC<ListArchiveCardProps> = ({
  artifact,
  voteMap,
  hoveredVideoId,
  onVideoHover,
  ...
  return (
    ...
    >
      <div className="flex flex-col md:flex-row">
        ...
        <div 
          className="relative md:w-48 h-32 bg-black flex-shrink-0"
        ...
        <div className="flex-1 p-4">
          <div className="flex items-start justify-between mb-2">
            <div className="flex-1">
              <div className="flex items-center gap-2 mb-1 flex-wrap">
                <h3 className="text-base font-semibold text-[#dbe3eb] hover:text-[#98dc48] transition-colors">
                  {artifact.title}
                </h3>
                <div 
              ...
              <div className="flex items-center gap-3 text-xs text-[#8fa0b3] flex-wrap">
          ...
          {voteCategories.length > 0 && (
            <div className="flex flex-wrap gap-2 mb-3">
              {voteCategories.map(([category, count]) => (
          ...
          {artifact.tags && artifact.tags.length > 0 && (
            <div className="flex flex-wrap gap-2">
              {artifact.tags.slice(0, 4).map((tag: any, idx: any) => (
                <span
                  key={idx}
