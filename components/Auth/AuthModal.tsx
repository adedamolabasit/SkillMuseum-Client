  ...
  return (
    ...
    >
      <div
        ...
        style={{
          boxShadow:
            "-12px -12px 24px rgba(48, 54, 70, 0.5), 12px 12px 24px rgba(0, 0, 0, 0.8), inset 1px 1px 1px rgba(255,255,255,0.05), 0 0 60px rgba(152, 220, 72, 0.08)",
        }}
      >
        <div
          ...
          style={{
            background:
              "linear-gradient(90deg, #98dc48, transparent 20%, transparent 80%, #9d72ff)",
            opacity: 0.7,
          }}
        />
